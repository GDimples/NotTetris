public class LPiece extends Tetrimino{
    ...
    public void rotateCW(Mino[][] board) {
        switch (rotation) {
            case 1:
                if (ypos != 0) {
                    if (board[ypos - 1][xpos] == null && board[ypos - 1][xpos + 1] == null && board[ypos + 1][xpos] == null) {
                        mino2.changeY(60);
                        mino3.changeX(30);
                        mino3.changeY(-30);
                        mino4.changeX(-30);
            ...
            case 2:
                if (xpos != 0) {
                    if (board[ypos][xpos - 1] == null && board[ypos][xpos + 1] == null && board[ypos - 1][xpos - 1] == null) {
                        mino4.changeX(-30);
                        mino4.changeY(-30);
                        mino2.changeX(-60);
                        mino3.changeX(30);
            ...
            case 3:
                if (ypos != 30) {
                    if (board[ypos + 1][xpos] == null && board[ypos - 1][xpos] == null && board[ypos + 1][xpos - 1] == null) {
                        mino4.changeX(30);
                        mino4.changeY(-30);
                        mino3.changeX(-30);
                        mino3.changeY(30);
